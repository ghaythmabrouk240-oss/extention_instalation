...
<form action="{{ route('installations.update', $installation) }}" method="POST">
    @csrf
    @method('PUT')
    <input type="hidden" name="type_profil" value="{{ $installation->type_profil }}">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="form-section">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" value="{{ $installation->type_profil }}" disabled>
                        @error('type_profil')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-4">
            ...
            @if($installation->type_profil === \App\Models\Installation::TYPE_IRM)
