...
<form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data">
    ...
    @endif
    <input type="hidden" name="requires_file" value="{{ $requiresFile ? '1' : '0' }}">
    <div class="form-section">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="version" class="form-control @error('version') is-invalid @enderror" value="{{ old('version', '1.0') }}" required>
                @error('version')
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" name="reference_dms" class="form-control @error('reference_dms') is-invalid @enderror" value="{{ old('reference_dms') }}">
                @error('reference_dms')
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="reference_fichier" class="form-control @error('reference_fichier') is-invalid @enderror" value="{{ old('reference_fichier') }}">
        ...
        <div class="mb-3">
            ...
            <input type="file" name="fichier" class="form-control @error('fichier') is-invalid @enderror" accept=".pdf,.jpg,.jpeg,.png,application/pdf,image/jpeg,image/png" @if($requiresFile) required @endif>
        ...
        <div class="d-flex gap-4">
            <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" name="est_bloquant" id="bloquant" value="1" {{ old('est_bloquant') ? 'checked' : '' }}>
                <label class="form-check-label" for="bloquant">Document bloquant</label>
            </div>
            <div class="form-check">
                <input type="hidden" name="est_version_active" value="0">
                <input class="form-check-input" type="checkbox" name="est_version_active" id="active" value="1" checked>
